...
public void SSO()
{
	driver.findElement(By.cssSelector("#username")).sendKeys("admin11");
	   driver.findElement(By.cssSelector("#password")).sendKeys("123456223");
...
{
	driver.findElement(By.cssSelector("input[id='userNameInput']")).sendKeys("bha@ipg.cloud");
